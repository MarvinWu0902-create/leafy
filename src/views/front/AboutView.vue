    ...
    <div>
        ...
        <div class="container grid grid-cols-1 gap-4 mb-10 md:grid-cols-3">
            ...
            <div class="col-span-1 p-10 md:p-4">
                ...
                <p class="mb-4 leading-8 text-gray-400 ">LEAFY 提供各式各樣的高品質茶葉，從清新的綠茶到香醇的紅茶，從獨特的白茶到濃郁的烏龍茶。</p>
        ...
        <div class="container grid grid-cols-1 gap-4 mb-10 md:grid-cols-2">
            ...
            <div class="flex flex-col col-span-1 p-10">
                <div>
                    <h3 class="mb-4 text-2xl font-bold tracking-widest text-primary">加入 LEAFY 的日常</h3>
                </div>
                <div>
                    <p class="mb-4 leading-8 text-gray-400">LEAFY不只是賣茶，我們在乎的是賣給您一種生活的可能性。</p>
                    <p class="mb-4 leading-8 text-gray-400">可能是您一天中的一個小確幸，一個短暫的逃離，或是與家人朋友共享的溫馨時刻。</p>
                    <p class="mb-4 leading-8 text-gray-400">我們邀請您加入LEAFY的世界，讓這份簡單而純粹的喜悅成為您日常生活的一部分。</p>
                </div>
            </div>
            <div class="col-span-1 hidden md:block h-[400px] bg-join bg-center bg-cover rounded-lg"></div>
        </div>
    </div>
</template>
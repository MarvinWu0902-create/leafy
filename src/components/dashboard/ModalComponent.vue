<template>
    <div>
        ...
        <Transition name="content" enter-active-class="transition duration-300" leave-active-class="transition duration-300"
            enter-from-class="opacity-0 translate-y-[100px]" enter-to-class="translate-y-0 opacity-100"
            leave-from-class="translate-y-0 opacity-100" leave-to-class="opacity-0 translate-y-[100px]">
            <div class="fixed inset-0 z-20 flex items-center justify-center" v-if="isModalShow">
                <div class="w-1/2 max-h-full overflow-x-auto bg-white rounded-lg shadow-lg">
